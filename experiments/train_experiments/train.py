...
def get_args():
    ...
    parser.add_argument("--run_name", type=str, default=run_name, help="Name of the run for Wandb.")
...
if __name__ == "__main__":
    ...
    train(
        ...
        run_name=args.run_name if args.run_name else run_name,
        scheduler=scheduler,
